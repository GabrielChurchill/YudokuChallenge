...
export default function SudokuGrid({ grid, selectedCell, onCellSelect }: SudokuGridProps) {
  ...
  return (
    <div className="grid grid-cols-9 gap-1 max-w-lg mx-auto aspect-square bg-gray-800 p-2 rounded-lg">
        ...
        row.map((cell, colIndex) => {
          ...
          return (
            <button
              ...
              className={cn(
                "bg-white border border-gray-300 flex items-center justify-center text-xl font-semibold transition-colors min-h-12",
